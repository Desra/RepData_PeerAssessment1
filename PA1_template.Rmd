...
![Figure taken from path /figure/](/figure/unnamed-chunk-7-1.png)
...
plot(aggregateMeanStepsPerInterval,
     ...
     col="Blue")
```
![Figure taken from path /figure/](/figure/unnamed-chunk-10-1.png)
...
```
![Figure taken from path /figure/](/figure/unnamed-chunk-16-1.png)
...
ggplot(aggregateSumStepsPerDay3, aes(interval, steps)) + 
        ...
        ylab("The average number of steps taken")
```
![Figure taken from path /figure/](/figure/unnamed-chunk-20-1.png)